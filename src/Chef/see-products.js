...
class SeeProductsChef extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            id: "",
    ...
    goToUpdateProduct = id => {
        localStorage.setItem('productToUpdate', id);
                    ...
                    {this.state.products.map(product => {
                        return (
                            <div className="productChef">
                                ...
                                <div className="buttonsChef">
                                    <button onClick={() => this.goToUpdateProduct(product.id)} className={` buttonChef`}>
                                        Update
                                    </button>
                                </div>
...
export default SeeProductsChef;